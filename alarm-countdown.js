...
var wasmBinaryFile = 'alarm-countdown.wasm';
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_current=5584;
  
  
  var ___tm_timezone=(stringToUTF8("GMT", 5632, 4), 5632);function _localtime_r(time, tmPtr) {
      _tzset();
...
var asmGlobalArg = {};
var asmLibraryArg = { "__handle_stack_overflow": ___handle_stack_overflow, "asctime": _asctime, "difftime": _difftime, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_memcpy_big": _emscripten_memcpy_big, "emscripten_resize_heap": _emscripten_resize_heap, "fd_close": _fd_close, "fd_read": _fd_read, "fd_seek": _fd_seek, "fd_write": _fd_write, "localtime": _localtime, "memory": wasmMemory, "mktime": _mktime, "nanosleep": _nanosleep, "setTempRet0": _setTempRet0, "table": wasmTable, "time": _time };
var asm = createWasm();
Module["asm"] = asm;
/** @type {function(...*):?} */
